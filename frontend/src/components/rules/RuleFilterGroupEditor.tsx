/**
 * RuleFilterGroupEditor - Group of conditions with AND/OR operator for rules
 */

import { clsx } from 'clsx';
import { FilterGroup, FilterCondition, FilterOperator } from '../../types';
import { RuleFilterConditionRow } from './RuleFilterConditionRow';

interface RuleFilterGroupEditorProps {
  group: FilterGroup;
  groupIndex: number;
...
export function RuleFilterGroupEditor({
  group,
  groupIndex,
  onOperatorChange,
  onAddCondition,
